...
// import img
import imgUpload from ".././assets/images/revoke.jpg";

const createRevoke = (props) => {
  ...
  function handlePostProduct() {
    ...
    props.connecttransaction.revokePermissionToCreateProduct(
      ...
      <div className="container-create-product">
        ...
        <div className="container-right">
          <form className="form-create-product">
            <textarea id="description" name="description"  placeholder="Nhập địa chỉ người dùng thu hồi quyền" onChange={getDetailProduct}/>
          </form>
